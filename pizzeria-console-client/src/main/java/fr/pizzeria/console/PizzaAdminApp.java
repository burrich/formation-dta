...
import fr.pizzeria.dao.DaoFactoryJpa;
import fr.pizzeria.dao.DaoFactoryMemoire;
...
//			}
		...
		case 3:
			...
			lancerApplication(new DaoFactoryJpa(emFactory));;
			emFactory.close();
		case 99:
			break;
		default:
	...
	private static void lancerApplication(DaoFactory daoFactory) {
