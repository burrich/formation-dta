...
public class MenuCommande {
	 ...
	 */
	public MenuCommande(Scanner sc, DaoFactory daoFactory) {
	...
	private void initialiserOptions(DaoFactory daoFactory,  Scanner sc) {
		this.sc = sc;
		options.put(1, new CommanderPizzaOptionMenu(daoFactory, this.sc));
		options.put(2, new ListerCommandesOptionMenu(daoFactory, this.sc));
